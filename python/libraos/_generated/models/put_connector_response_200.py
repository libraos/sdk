...
T = TypeVar("T", bound="PutConnectorResponse200")


@_attrs_define
class PutConnectorResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_connector_response_200 = cls(
            connector=connector,
        )

        put_connector_response_200.additional_properties = d
        return put_connector_response_200
