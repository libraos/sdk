...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/apps/{name}/install".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Install or reactivate an app
     ...
     Installs (or reactivates) the staged app: validates its manifest, applies pending migrations, and
    registers its agents. Admin-only.
