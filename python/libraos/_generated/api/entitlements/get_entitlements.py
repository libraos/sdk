...
def sync_detailed(
    *,
    ...
    """Get a tenant's effective entitlement flags
     ...
     Returns the tenant's effective flags (free floor overlaid with any stored overrides). A tenant with
    no stored row reads the free floor. The tenant is supplied via the tenant query parameter.
