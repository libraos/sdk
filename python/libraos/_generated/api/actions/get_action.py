...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/managed/actions/{id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Fetch one pending action
     ...
     Admins may fetch any action; group members may fetch actions for their groups. An unknown id and a
    no-access id both return 404 (existence is not leaked).
