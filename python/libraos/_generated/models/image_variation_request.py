...
from .. import types
from ..models.image_variation_request_response_format import ImageVariationRequestResponseFormat
from ..types import UNSET, File, Unset

T = TypeVar("T", bound="ImageVariationRequest")
...
class ImageVariationRequest:
    ...
    Attributes:
        ...
        image (File): Source image to create variations of.
        n (int | Unset):  Default: 1.
        size (str | Unset):  Example: 1024x1024.
        response_format (ImageVariationRequestResponseFormat | Unset):
    """
    ...
    response_format: ImageVariationRequestResponseFormat | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_response_format, Unset):
            ...
            response_format = ImageVariationRequestResponseFormat(_response_format)

        image_variation_request = cls(
            model=model,
            image=image,
            n=n,
            size=size,
        ...
        image_variation_request.additional_properties = d
        return image_variation_request
