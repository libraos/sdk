...
from ...models.rename_conversation_body import RenameConversationBody
...
def sync_detailed(
    ...
    *,
    ...
    """Rename a conversation
     ...
     Set the conversation title. The title is trimmed; empty after trim clears it. Limited to 200
    characters.
