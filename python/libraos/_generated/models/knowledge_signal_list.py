...
T = TypeVar("T", bound="KnowledgeSignalList")


@_attrs_define
class KnowledgeSignalList:
    """
    Attributes:
        signals (list[KnowledgeSignal] | Unset):
        total (int | Unset): Number of signals returned.
    """

    signals: list[KnowledgeSignal] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _signals is not UNSET:
            ...
            for signals_item_data in _signals:
                signals_item = KnowledgeSignal.from_dict(signals_item_data)

                signals.append(signals_item)

        total = d.pop("total", UNSET)

        knowledge_signal_list = cls(
            signals=signals,
            total=total,
        )

        knowledge_signal_list.additional_properties = d
        return knowledge_signal_list
